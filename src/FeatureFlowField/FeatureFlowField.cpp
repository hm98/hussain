...
int main()
{
    ...
    freopen("../../outputs/data/randomSeeds.data", "w", stdout);
    ...
    FILE * Output = fopen( "../../outputs/images/DistanceMap.png" , "wb" ) ;
    FILE * Output1 = fopen( "../../outputs/images/FeatureMap.png" , "wb" ) ;
    FILE * Output2 = fopen( "../../outputs/images/RandomSeeds.png" , "wb" ) ;
    ...
    freopen("../../outputs/data/salientPoints.data", "r", stdin);
